<nav class="col-span-1 w-full  bg-[var(--dark-eco)]">
  ...
  <section class="w-full flex flex-col items-center justify-center my-[1rem]">
    <a href="" class="py-[0.6rem] w-full text-black pl-[1rem] bg-white/60 text-xl hover:bg-white transition">Inicio</a>
  </section>
  <form method="POST" action="{{ route('logout') }}">
    @csrf
    <button type="submit" 
    class="cursor-pointer font-bold text-start px-[1rem] py-[0.6rem] bg-red-500 w-full transition text-white duration-500 hover:bg-red-400 hover:text-[var(--dark-eco)] parrafo-eco"
