    ...
    <article class="flex items-start gap-5 flex-wrap md:flex-nowrap">
      ...
      <section class="w-full">
        ...
        <article class="w-full min-h-[5rem] bg-[var(--dark-eco)] rounded-lg flex items-center px-[1rem] gap-[1rem]">
          <label class="bg-white rounded-lg p-[1rem] hover:opacity-50 cursor-pointer transition has-[:checked]:opacity-50">
            ...
            <input type="radio" name="metodopago"  value="transferencia" class="hidden"/>
          </label>
          <label class="bg-white rounded-lg p-[1rem] hover:opacity-50 cursor-pointer transition has-[:checked]:opacity-50">
            ...
            <input type="radio" name="metodopago" value="paypal" class="hidden "/>
          </label>
          <label class="bg-white rounded-lg p-[1rem] hover:opacity-50 cursor-pointer transition  has-[:checked]:opacity-50">
            ...
            <input type="radio" name="metodopago" value="tarjeta" class="hidden"/>
          </label>
        </article>
